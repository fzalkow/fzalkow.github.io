<!--
.. title: Twelve Tone Row Tables with Common Lisp, LilyPond, and LaTeX
...
In the following an old version is described, which uses LilyPond and LaTeX. A new version, which only depends on LilyPond, is to be found on [GitHub](https://github.com/fzalkow/12tone-table). There is also to be found an executable, which doesn't require any Common Lisp implementation.
...
Concerning questions, remarks or whatever: You can [conctact me](/en/about-me.html)!
